...
expected_minutes_in_oven:
    ...
    mov rax, 40                         ; sets expected oven time
    ret
...
remaining_minutes_in_oven:
    ...
    call expected_minutes_in_oven       ; remembers the total time
    sub rax, rdi                        ; subtracts from remaining time
    ret
...
preparation_time_in_minutes:
    ...
    ; This function takes one number as argument and must return a number
    mov rax, 2                          ; stores the multiplicator
    imul rdi                            ; multiplies
    ret
...
elapsed_time_in_minutes:
    ...
    call preparation_time_in_minutes    ; calculates preparation time
    add rax, rsi                        ; adds baking time
    ret
